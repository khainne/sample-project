<%@ tag trimDirectiveWhitespaces="true" description="Session Expire Modal" pageEncoding="UTF-8"%>
   ...
   <div class="modal--content">
      ...
      <div class="row">
         <div class="column medium-12">
            <p>
               <spring:message code="session.modal.message"/>
            </p>
            <span class="js-clock clock">
               <span class="clock--seconds-timer js-seconds-timer"></span>
               <span class="clock--seconds-label">
                  <spring:message code="session.modal.seconds"/>
               </span>
            </span>
            <a href="#" class="button centered">
               <spring:message code="session.modal.button.imStillHere"/>
            </a>
         </div>
      </div>
   </div>
